...
axios.get(`https://github-readme-stats.vercel.app/api/top-langs?username=rafavermar&show_icons=true&locale=en&layout=compact&token=${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}`)
  .then(response => {
...
axios.get(`https://github-readme-stats.vercel.app/api?username=rafavermar&show_icons=true&locale=en&token=${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}`)
  .then(response => {
    console.log(response.data);
  })
  .catch(error => {
...
axios.get(`https://github-readme-streak-stats.herokuapp.com/?user=rafavermar&token=${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}`)
  .then(response => {
    console.log(response.data);
  })
  .catch(error => {
